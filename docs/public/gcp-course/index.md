...
| **03** | [**Gemini Enterprise, Vertex AI & Generowanie A2UI**](03-gemini-enterprise.md) | Wykorzystanie modeli Gemini w środowisku korporacyjnym, prywatność danych, Function Calling, uziemienie RAG, generowanie interfejsów A2UI w system prompt oraz projektowanie wizualnych komponentów i szablonów. |
